...
//        collectionView.register(UICollectionViewCell.self, forCellWithReuseIdentifier: "string")
...
//        
//        NSLayoutConstraint.activate([
//            collectionView.topAnchor.constraint(equalTo: divider.bottomAnchor, constant: 15),
